...
"use strict";(()=>{var X=[..."abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-._~"],Q=[..."0123456789"],$=[..."CDEHKMPRTUWXY012458"],ee=[..."!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~"],te=[..."ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"],j=(e,t)=>e[t]+(e[t+1]<<8),re=(e,t,r)=>{let n=t.length,o=Math.floor(65536/n)*n-1,s=2*Math.ceil(1.1*e),i="",a=0;for(;a<e;){let u=r(s),d=0;for(;d<s&&a<e;){let f=j(u,d);d+=2,!(f>o)&&(i+=t[f%n],a++)}}return i},ne=async(e,t,r)=>{let n=t.length,o=Math.floor(65536/n)*n-1,s=2*Math.ceil(1.1*e),i="",a=0;for(;a<e;){let u=await r(s),d=0;for(;d<s&&a<e;){let f=j(u,d);d+=2,!(f>o)&&(i+=t[f%n],a++)}}return i},oe=new Set([void 0,"hex","base64","url-safe","numeric","distinguishable","ascii-printable","alphanumeric"]),A=(e,t,r)=>({length:n,type:o,characters:s})=>{if(!(n>=0&&Number.isFinite(n)))throw new TypeError("Expected a `length` to be a non-negative finite number");if(o!==void 0&&s!==void 0)throw new TypeError("Expected either `type` or `characters`");if(s!==void 0&&typeof s!="string")throw new TypeError("Expected `characters` to be string");if(!oe.has(o))throw new TypeError(`Unknown type: ${o}`);if(o===void 0&&s===void 0&&(o="hex"),o==="hex"||o===void 0&&s===void 0)return t(Math.ceil(n*.5),"hex",n);if(o==="base64")return t(Math.ceil(n*.75),"base64",n);if(o==="url-safe")return e(n,X,r);if(o==="numeric")return e(n,Q,r);if(o==="distinguishable")return e(n,$,r);if(o==="ascii-printable")return e(n,ee,r);if(o==="alphanumeric")return e(n,te,r);if(s.length===0)throw new TypeError("Expected `characters` string length to be greater than or equal to 1");if(s.length>65536)throw new TypeError("Expected `characters` string length to be less or equal to 65536");return e(n,s,r)};function D(e,t){return A(re,e,t)}function q(e,t){return A(ne,e,t)}var se=e=>[...e].map(t=>t.toString(16).padStart(2,"0")).join(""),ie=e=>btoa(String.fromCodePoint(...e)),R=65536;function k(e){let t=new Uint8Array(e);for(let r=0;r<e;r+=R)t.set(crypto.getRandomValues(new Uint8Array(Math.min(R,e-r))),r);return t}function z(e,t,r){let n=k(e);return(t==="hex"?se:ie)(n).slice(0,r)}var v=D(z,k),Se=q(z,k);var T=()=>{let e=new Error;if(!e.stack)throw new Error("Stack trace is not available!");return e.stack},ce=(e=T())=>{if(e.includes("@")){let n=e.split(`
