...
"use strict";(()=>{var X=[..."abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-._~"],Q=[..."0123456789"],$=[..."CDEHKMPRTUWXY012458"],ee=[..."!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~"],te=[..."ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"],C=(e,t)=>e[t]+(e[t+1]<<8),re=(e,t,r)=>{let n=t.length,o=Math.floor(65536/n)*n-1,s=2*Math.ceil(1.1*e),i="",u=0;for(;u<e;){let a=r(s),d=0;for(;d<s&&u<e;){let f=C(a,d);d+=2,!(f>o)&&(i+=t[f%n],u++)}}return i},ne=async(e,t,r)=>{let n=t.length,o=Math.floor(65536/n)*n-1,s=2*Math.ceil(1.1*e),i="",u=0;for(;u<e;){let a=await r(s),d=0;for(;d<s&&u<e;){let f=C(a,d);d+=2,!(f>o)&&(i+=t[f%n],u++)}}return i},oe=new Set([void 0,"hex","base64","url-safe","numeric","distinguishable","ascii-printable","alphanumeric"]),A=(e,t,r)=>({length:n,type:o,characters:s})=>{if(!(n>=0&&Number.isFinite(n)))throw new TypeError("Expected a `length` to be a non-negative finite number");if(o!==void 0&&s!==void 0)throw new TypeError("Expected either `type` or `characters`");if(s!==void 0&&typeof s!="string")throw new TypeError("Expected `characters` to be string");if(!oe.has(o))throw new TypeError(`Unknown type: ${o}`);if(o===void 0&&s===void 0&&(o="hex"),o==="hex"||o===void 0&&s===void 0)return t(Math.ceil(n*.5),"hex",n);if(o==="base64")return t(Math.ceil(n*.75),"base64",n);if(o==="url-safe")return e(n,X,r);if(o==="numeric")return e(n,Q,r);if(o==="distinguishable")return e(n,$,r);if(o==="ascii-printable")return e(n,ee,r);if(o==="alphanumeric")return e(n,te,r);if(s.length===0)throw new TypeError("Expected `characters` string length to be greater than or equal to 1");if(s.length>65536)throw new TypeError("Expected `characters` string length to be less or equal to 65536");return e(n,s,r)};function D(e,t){return A(re,e,t)}function q(e,t){return A(ne,e,t)}var se=e=>[...e].map(t=>t.toString(16).padStart(2,"0")).join(""),ie=e=>btoa(String.fromCodePoint(...e)),R=65536;function T(e){let t=new Uint8Array(e);for(let r=0;r<e;r+=R)t.set(crypto.getRandomValues(new Uint8Array(Math.min(R,e-r))),r);return t}function z(e,t,r){let n=T(e);return(t==="hex"?se:ie)(n).slice(0,r)}var v=D(z,T),Se=q(z,T);var k=()=>{let e=new Error;if(!e.stack)throw new Error("Stack trace is not available!");return e.stack},ce=(e=k())=>{if(e.includes("@")){let n=e.split(`
...
`).slice(2),r=[];for(let n of t){let o=n.slice(n.indexOf("(")+1||n.indexOf("at")+3,n.lastIndexOf(":",n.lastIndexOf(":")-1));r.push(o)}return r},H=(e=ce())=>{let t=0;for(let r of e){let n=r.indexOf("://");if(n===5||n===4)break;t++}return e.slice(t)};var l=(e,t)=>{for(let r of t)if(e.includes(r))return!0;return!1};var w=["07c225f3.online","css-load.com","html-load.com","content-loader.com","22d2d4d9-0c15-4a3a-9562-384f2c100146.xyz","f97ae142.online","html-load.cc","error-report.com","2aeabdd4-3280-4f03-bc92-1890494f28be.xyz","e1577bbd-2a7e-4bee-b2fe-12a6406689e5.xyz","fadeb9a7-2417-4a51-8d99-0421a5622cbe.xyz"],y=[...w,"failed to load website","blocking software"],ae=w.length,F=()=>w[Number(v({length:16,type:"numeric"}))*1e-16*ae>>>0],N=(e=H())=>e.length===0?!1:!!l(e[e.length-1],w);var M=[{id:"kynb",input:'0Nm}ubC9L6k{7("nx>s=Ko]IBw/ySgf%W',output:"a274bcljtv0omw6z9g5p13us8ekhxirfq",reserved1:121,reserved1Input:"e?`3AU<2Z[;	iJEFV'|Pa8T5j-.v :q#H)",reserved1Output:"eow5rfluq8x4zgj70p13ci6mh2s9tnkabv",reserved2:110,reserved2Input:`&XD_QOhMrltpR1c4zG
...
XLurypqA8[eIw-DR|kbB`,reserved1Output:"ou7ercvw9l01yghnfip685bzxqtak3sjm4",reserved2:57,reserved2Input:"=6a0G>POo37nv?x&1`]2t",reserved2Output:"crxmjf7yhgt6o3p8l09iv"}];var L={Debug:!1};var p=e=>{let t=`[microShield:${e}]`;return new Proxy(console.debug,{apply(r,n,o){Reflect.apply(r,n,[t,...o])}})};var U=typeof unsafeWindow<"u"?unsafeWindow:window,de=p("secret"),h=v({length:20}),S=(e,t,r)=>{de(t?"-":"+","name="+e,"v=",r,"stack=",k())},O=(e,t)=>new Proxy(e,{apply(r,n,o){let s=()=>{throw S(t.Name,!0,o),new Error};if(N()&&s(),t.CheckArguments)for(let i of o.filter(u=>typeof u=="string"))l(i,y)&&s();if(t.CheckArgumentFunctions)for(let i of t.CheckArgumentFunctions)i(o)||s();if(t.CheckOutputs){let i=Reflect.apply(r,n,o);l(i.toLowerCase(),y)&&s()}return L.Debug&&S(t.Name,!1,o),Reflect.apply(r,n,o)},setPrototypeOf(r,n){throw S(t.Name,!0,n),new Error}}),I=fetch,g=new Set,pe=(e,t,r)=>{if(g.size===0){let n=O(Object.defineProperty,{CheckArgumentFunctions:[]}),o=O(Object.defineProperties,{CheckArgumentFunctions:[s=>{for(let i of Object.keys(s[1]))if(g.has(s[0][i]))return!1;return!0}]});g.add(n),g.add(o),Object.defineProperty(U.Object,"defineProperty",{value:n}),Object.defineProperties(U.Object,{defineProperty:{value:n},defineProperties:{value:o}})}Object.defineProperty(e,t,{value:r}),g.add(r)},c=(e,t,r)=>{let n=e[t];r===void 0&&(r={}),r.Name===void 0&&(r.Name=n.name),pe(e,t,O(n,r))};var fe=async e=>{let r=await(await I(e,{cache:"force-cache"})).text();if(r.length===0)throw new Error("Failed to fetch resource!");return"<style>"+r+"</style>"},W=async e=>{let r=await(await I(e,{cache:"force-cache"})).text(),n=/eyJ[\w-]*\.eyJ[\w-]*\.[\w-]*/.exec(r);if(n===null)throw new Error("Failed to match predefined token in the script!");return n[0]},_=async(e,t)=>{let r=/(resources:\/\/[^'"]+)/g,n=F(),o="",s=null;for(;(s=r.exec(e))!==null;){let i="https://"+n+"/resources/"+s[1].slice(12)+"?token="+t;o+=await fe(i).catch(u=>(console.error(u),""))}return o};var x="asdf-",G=()=>{c(window.Storage.prototype,"setItem",{CheckArgumentFunctions:[e=>!e[0].startsWith(x)||e[2]===h]}),c(window.Storage.prototype,"removeItem",{CheckArgumentFunctions:[e=>!e[0].startsWith(x)||e[1]===h]}),c(window.Storage.prototype,"clear")},K=e=>localStorage.getItem(x+e,h),J=(e,t)=>{localStorage.setItem(x+e,t,h)};var le=p("entities");var me=e=>{let t=document.querySelector(e.Selector);if(!t)throw new Error("The target node was not found in the frame!");t.before(e.TextContent),t.remove()},ye=e=>{document.head.insertAdjacentHTML("beforeend",e.Html)},ge=async e=>{e.Type===1?ye(e):e.Type===0&&me(e)},b=async e=>Promise.allSettled(e.map(async t=>ge(t))),V=async()=>{let e=K("entity-cache-rev2");if(!e)throw new Error("The cached entities does not exist on this browser!");let t=JSON.parse(e);if(Date.now()-t.CreatedAt>1e3*60*60*24*30)throw new Error("The cached entities are too old!");if(!t.Entities.reduce((n,o)=>o.Type===1?n+o.Html.length:n,0))throw new Error("The cached entities has no content!");return le("restoring cached entities data=",t),await b(t.Entities),!0},Y=e=>{e.length!==0&&J("entity-cache-rev2",JSON.stringify({Entity:e,CreatedAt:Date.now()}))};var m=async(e=document)=>{if(e.readyState==="loading")return new Promise(t=>{e.addEventListener("readystatechange",()=>{t()})})};var E=p("ztinywave"),he=e=>{let t=e.slice(0,4),r=M.find(a=>a.id===t);if(!r)throw new Error("DEFUSER_ZTINYWAVE_KEY_NOT_FOUND");let n=String.fromCharCode(r.reserved1),o=String.fromCharCode(r.reserved2),s=(a,d,f)=>{let j=d.indexOf(f);return j>=0?a[j]:f},i=0,u=e.slice(4).split("").map(a=>{if(!i){if(a===n)return i=1,"";if(a===o)return i=2,""}return i===1?(i=0,r.reserved1Output.includes(a)?s(r.reserved1Input,r.reserved1Output,a):s(r.input,r.output,a)+a):i===2?(i=0,r.reserved2Output.includes(a)?s(r.reserved2Input,r.reserved2Output,a):s(r.input,r.output,a)+a):s(r.input,r.output,a)}).join("");return JSON.parse(u)},ve=async()=>{let e=[],t=()=>{let r=document.querySelectorAll('script[data]:not([data=""]),script[wp-data]:not([wp-data=""])');for(let n of r){let o=n.getAttribute("src"),s=n.getAttribute("data");o&&s&&e.push({Script:o,Data:s})}};if(t(),e.length===0&&(await m(document),t()),e.length===0)throw new Error("DEFUSER_ZTINYWAVE_TARGET_NOT_FOUND");return e},B=async()=>{if(await V().catch(o=>(E("Failed to initialise cached entities",o),!1)))return;let t=[],n=(await ve()).map(async o=>{E("source",o);let s=he(o.Data);E("payload",s);let i=[],u=[];for(let d of s)d.tags&&(d.tags.includes("resources://")?u.push({Type:1,Html:d.tags}):i.push({Type:1,Html:d.tags}));b(i);let a=await W(o.Script);for(let d of u)d.Type===1&&(d.Html=await _(d.Html,a));return b(u),t.push(...i,...u),t});E("sources resolves",await Promise.allSettled(n)),Y(t)};var P=p("[microShield:basedrop]"),Z=async()=>{await m(document);let e="";for(let t of document.querySelectorAll("script[wp-data]")){let r=t.getAttribute("wp-data");if(!r){P("empty attribute",t);continue}let n;try{n=new TextDecoder().decode(Uint8Array.from(atob(r),o=>o.charCodeAt(0)))}catch(o){P("failed to decode base64 stream",o);continue}if(!n.startsWith("<")){P("failed to decode encoded text",n);continue}e+=n}e&&document.head.insertAdjacentHTML("beforeend",e)};var we=()=>{let e=typeof unsafeWindow<"u"?unsafeWindow:window;c(e,"Error"),c(e.EventTarget.prototype,"addEventListener"),c(e.MessagePort.prototype,"postMessage"),c(e.Element.prototype,"remove"),c(e.Element.prototype,"removeChild"),c(e.Element.prototype,"insertAdjacentElement"),c(e.Element.prototype,"insertAdjacentHTML"),c(e,"setInterval"),c(e,"setTimeout"),c(e.Element.prototype,"setAttribute",{CheckArguments:!0}),c(e.Element.prototype,"setAttributeNS",{CheckArguments:!0}),c(e.document,"createElement"),c(e.document,"createElementNS"),c(e,"alert",{CheckArguments:!0}),c(e,"confirm",{CheckArguments:!0}),c(e,"atob",{CheckOutputs:!0}),c(e,"decodeURI"),c(e,"decodeURIComponent"),G(),c(e,"fetch",{CheckArguments:!0})},xe=()=>{let e=p("observe");new MutationObserver(r=>{for(let n of r)for(let o of n.addedNodes)o instanceof HTMLElement&&l(o.innerHTML,y)&&(o.remove(),e(o))}).observe(document.body,{subtree:!0,childList:!0})},be=()=>{we(),B(),Z(),m().then(()=>{xe()})};be();})();
